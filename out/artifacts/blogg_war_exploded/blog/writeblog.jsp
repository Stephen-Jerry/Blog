...
<head>
    ...
    <script>
        ...
        function save(){
            document.getElementById("writeblog").action="/savedraftServlet";
...
<form method="post" action="/writeblogServlet" id="writeblog">
    <div id="head">
        <input type="text" class="form-control"  placeholder="请输入文章标题" style="width: 1050px;margin-left: 67px" name="headline" maxlength="29">
    ...
    <div id="test-editormd" >
        <!--111111-->
        <textarea id="test-editormd-markdown" name="test-editormd-markdown"  style="display:none;"></textarea>
        <!-- 注意：name属性的值-->
