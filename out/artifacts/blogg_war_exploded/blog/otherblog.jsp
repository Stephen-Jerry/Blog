...
<div class="container-fluid">
    ...
    <div class="container-fluid you">
        ...
        <ul class="nav nav-pills nav-justified">
            <li role="presentation" class="active"><a href="/otherpageServlet?bloguserid=${sessionScope.bloguserid}&userid=${sessionScope.userid}">按最后发布时间</a></li>
            <li role="presentation"><a href="/otherpageServlet2?bloguserid=${sessionScope.bloguserid}&userid=${sessionScope.userid}">原创</a></li>
            ...
            <nav aria-label="Page navigation" style="text-align: center">
                <ul class="pagination">
                    ...
                    <li>
                        ...
                        <a href="${pageContext.request.contextPath}/otherpageServlet?nowpage=${page.nowpage-1}&count=5&bloguserid=${sessionScope.bloguserid}&userid=${sessionScope.userid}" aria-label="Previous">
                    ...
                    <c:if test="${page.nowpage-2<=1}">
                        <c:forEach begin="1" end="${page.nowpage}" var="i">
                            <c:if test="${page.nowpage==i}">
                                <li class="active"><a href="${pageContext.request.contextPath}/otherpageServlet?nowpage=${i}&count=5&bloguserid=${sessionScope.bloguserid}&userid=${sessionScope.userid}">${i}</a></li>
                            </c:if>
                            <c:if test="${page.nowpage!=i}">
                                <li><a href="${pageContext.request.contextPath}/otherpageServlet?nowpage=${i}&count=5&bloguserid=${sessionScope.bloguserid}&userid=${sessionScope.userid}">${i}</a></li>
                            </c:if>
                        </c:forEach>
                    </c:if>
                    <!--前半部分有多余页-->
                    <c:if test="${page.nowpage-2>1}">
                        <c:if test="${1==page.nowpage}">
                            <li class="active"><a href="${pageContext.request.contextPath}/otherpageServlet?nowpage=1&count=5&bloguserid=${sessionScope.bloguserid}&userid=${sessionScope.userid}">1</a></li>
                        </c:if>
                        <c:if test="${1!=page.nowpage}">
                            <li><a href="${pageContext.request.contextPath}/otherpageServlet?nowpage=1&count=5&bloguserid=${sessionScope.bloguserid}&userid=${sessionScope.userid}">1</a></li>
                        </c:if>
                        <li><a>...</a></li>
                    ...
                    <c:if test="${page.nowpage+2<page.totalpage}">
                        <c:forEach begin="${page.nowpage+1}" end="${page.nowpage+2}" var="i">
                            ...
                            <c:if test="${page.nowpage!=i}">
                                <li><a href="${pageContext.request.contextPath}/otherpageServlet?nowpage=${i}&count=5&id=${id}">${i}</a></li>
                            </c:if>
                        </c:forEach>
                        <li><a>...</a></li>
                        <c:if test="${page.totalpage==page.nowpage}">
                            <li class="active"><a href="${pageContext.request.contextPath}/otherpageServlet?nowpage=${page.totalpage}&count=5&bloguserid=${sessionScope.bloguserid}&userid=${sessionScope.userid}">${page.totalpage}</a></li>
                        </c:if>
                        <c:if test="${page.totalpage!=page.nowpage}">
                            <li><a href="${pageContext.request.contextPath}/otherpageServlet?nowpage=${page.totalpage}&count=5&bloguserid=${sessionScope.bloguserid}&userid=${sessionScope.userid}">${page.totalpage}</a></li>
                        </c:if>
                    </c:if>
                    <c:if test="${page.nowpage+2>=page.totalpage}">
                    ...
                    <li>
                        ...
                        <a href="${pageContext.request.contextPath}/otherpageServlet?nowpage=${page.nowpage + 1}&count=5&bloguserid=${sessionScope.bloguserid}&userid=${sessionScope.userid}" aria-label="Next">
