...
public class PageDao {
   public Page<Blog> pagedao(int page,int count,int id){
       ...
       try {
           ...
           String sql="select count(*) total from blog where userid=?";
           ...
           String sql2="select * from blog where userid=? order by publicc DESC limit ?,?";
