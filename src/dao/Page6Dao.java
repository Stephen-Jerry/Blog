...
public class Page6Dao {
    public Page<FanorNotice> pagedao6(int page, int count, int id){
        ...
        try {
            ...
            String sql="select count(*) total from notice where id=?";
            ...
            String sql2="select * from notice where id=? limit ?,?";
            ...
            while(rs2.next()){
                ...
                ps3.setInt(1,rs2.getInt("noticeid"));
