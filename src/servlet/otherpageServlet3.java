...
@WebServlet("/otherpageServlet3")
public class otherpageServlet3 extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Page<Blog> pg=new otherpageDao().pagedao3(Integer.parseInt(nowpage),Integer.parseInt(count),Integer.parseInt(bloguserid));
        ...
        resp.sendRedirect("/blog/otherblog3.jsp");
    }
